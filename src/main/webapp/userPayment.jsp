...
<div class="buttons">
    <form action="NewPayment-Servlet" method="post">
...
<div class="overlay" id="overlay">
    <div class="overlay-text" id="overlayText">
        <span onclick="hideOverlay()" class="close-button">&times;</span> <!-- Close button -->
        <p id="overlayMessage"></p> <!-- Message text -->
    </div>
</div>
...
<script>
    ...
    function showOverlayWithText() {
        ...
        <%--let msg;--%>
        <%--if('${requestStatus}' === 'approved') msg = 'Your request has been approved!!!';--%>
        <%--else {msg = 'Your request is still pending.Come back again later.';--%>
